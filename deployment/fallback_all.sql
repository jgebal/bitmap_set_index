BEGIN EXECUTE IMMEDIATE 'DROP PACKAGE mapping_util'; EXCEPTION WHEN OTHERS THEN NULL; END;
/
...
BEGIN EXECUTE IMMEDIATE 'DROP TABLE bitmap_mapping_table'; EXCEPTION WHEN OTHERS THEN NULL; END;
/
BEGIN EXECUTE IMMEDIATE 'DROP TABLE bmap_idx_stor_t'; EXCEPTION WHEN OTHERS THEN NULL; END;
/
